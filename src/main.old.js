...
window.addEventListener('load', () => {
    setTimeout(() => {
        ...
        function createHUDInventory() {
            ...
            menu.setAttribute('visible', false); // HIDDEN BY DEFAULT (booléen)
        ...
        startBtn.onclick = async () => {
            ...
            setTimeout(async () => {
                ...
                try {
                    ...
                    // Controllers Three.js - stocker globalement
                    window.ctrl0 = sceneEl.renderer.xr.getController(0);
                    window.ctrl1 = sceneEl.renderer.xr.getController(1);
                    ...
                    sceneEl.object3D.add(window.ctrl0);
                    sceneEl.object3D.add(window.ctrl1);
        ...
        function xrLoop(time, frame) {
                    ...
                    if (source.handedness === 'left' && source.gamepad) {
                        ...
                        if (yBtn && yBtn.pressed) {
                            if (!menuToggleLock) {
                                menuToggleLock = true;
                                if (inventoryEntity) {
                                    // Utiliser object3D.visible (booléen natif) plutôt que getAttribute
                                    const vis = inventoryEntity.object3D.visible;
            ...
            const handleControllerInteraction = (controller) => {
                ...
                // Utiliser object3D.visible (booléen natif) au lieu de getAttribute qui retourne un string
                const isMenuVisible = inventoryEntity && inventoryEntity.object3D && inventoryEntity.object3D.visible;
            ...
            // Execute for both controllers (utiliser ctrl0/ctrl1 comme fallback)
            // Si rightController/leftController ne sont pas encore définis, utiliser ctrl0/ctrl1 directement
